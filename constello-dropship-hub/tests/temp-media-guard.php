...
$checks = array(
    ...
    'request fingerprint dedupe' => false !== strpos( $guard, 'rest_pre_dispatch' ) && false !== strpos( $guard, 'FINGERPRINT_META' ) && false !== strpos( $guard, "hash( 'sha256'" ),
    'fingerprint persisted' => false !== strpos( $guard, 'rest_post_dispatch' ) && false !== strpos( $guard, 'remember_media_fingerprint' ),
    ...
    'cleanup only unattached media' => false !== strpos( $guard, "'post_parent'            => 0" ) && false !== strpos( $guard, 'wp_get_post_parent_id' ),
